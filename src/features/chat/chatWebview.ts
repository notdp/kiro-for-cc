...
import { getVoiceManager } from '../../extension';
    ...
    private _getHtmlForWebview(webview: vscode.Webview): string {
        ...
        return `<!DOCTYPE html>
            ...
            <head>
                ...
                <style>
                    body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; display: flex; flex-direction: column; height: 100vh; margin: 0; }
            ...
            <body>
                ...
                <div id="input-area">
                    <textarea id="prompt-input" placeholder="Chat coming in a future update..."></textarea>
